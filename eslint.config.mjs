...
const eslintConfig = [
  ...
  // Main rules configuration
  {
    ...
    rules: {
      ...
      // Astro components and pages follow framework conventions
      "check-file/filename-naming-convention": [
        "error",
        {
          ...
          // Astro pages: lowercase/kebab allowed (file-based routing)
          "src/pages/**/*.astro": "KEBAB_CASE",
          // Dynamic route pages: allow [slug] patterns
          "src/pages/**/*.ts": "KEBAB_CASE",
        },
        {
